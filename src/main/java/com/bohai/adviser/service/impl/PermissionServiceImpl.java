...
import com.bohai.adviser.persistence.dztg.SysPermissionMapper;
...
public class PermissionServiceImpl implements PermissionService {
    ...
    public List<TreeView> queryAllPermission(String parentPermissionId) {
        ...
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("parentPermissionId", parentPermissionId);
        List<SysPermission> list = this.sysPermissionMapper.queryPermissionsByParentPermissionId(map);
        ...
        if(list != null && list.size() > 0 ){
            ...
            for (SysPermission permission : list){
                ...
                treeView.setHref(permission.getUrl());
                //递归查询子菜单权限
                treeView.setNodes(this.queryAllPermission(permission.getId()));
